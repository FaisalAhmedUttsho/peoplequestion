		    	...
		    	<form action="" method="post" id="f" class="ff" enctype="multipart/form-data">
				  <table>
					...
					<tr>
						...
						<td><input type="email" name="u_email" required="required" value="<?php echo $user_email;
							?>"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="date" name="u_birthday" required="required" value="<?php echo $user_birthday;?>"></td>
					</tr>
					<tr>
